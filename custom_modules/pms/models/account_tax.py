...
class AccountTax(models.Model):
    ...
    max_base = fields.Float(string="Max Base Amount", help="The maximum base amount for this tax. If the base amount exceeds this value, the tax will be calculated on the max base amount.")
    is_max_base = fields.Boolean(string="Max Base?", default=False)
    ...
    def compute_all(self, price_unit, currency=None, quantity=1.0, product=None, partner=None, is_refund=False, handle_price_include=True, include_caba_tags=False, fixed_multiplicator=1):
        ...
        for tax in taxes:
            ...
            if tax.max_base <= tax_base_amount and tax.is_max_base == True:
                tax_base_amount = tax.max_base
